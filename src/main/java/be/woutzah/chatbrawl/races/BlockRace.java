...
public class BlockRace extends Race {
  ...
  public BlockRace(ChatBrawl plugin) {
    super(
        plugin,
        plugin.getConfig().getLong("blockrace.duration"),
        plugin.getConfig().getInt("blockrace.chance"),
        plugin.getConfig().getBoolean("blockrace.enable-firework"),
        plugin.getConfig().getBoolean("blockrace.enabled"),
        plugin.getConfig().getConfigurationSection("blockrace.rewards.commands"));
  ...
  private void getBlocksFromConfig() {
    try {
      ConfigurationSection configSection =
          getPlugin().getConfig().getConfigurationSection("blockrace.blocks");
