...
public class FishRace extends Race {
    ...
    private void getFishFromConfig() {
        try {
            final ConfigurationSection configSection = fishRaceConfig.getConfigurationSection("fishrace.fish");
            ...
            for (String materialString : Objects.requireNonNull(configSection).getKeys(false)) {
                ...
                fishMap.put(material, Math.max(1, configSection.getInt(materialString)));
            }
